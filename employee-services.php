...
<title>Employee Services | LTO HRIS</title>
    ...
    <section class="privacy-notice-section container">
        <div class="privacy-notice-wrap">
            ...
            <div class="privacy-block">
                <h3>Core Services</h3>
                <p>LTO HRIS Employee Services provides a centralized platform for leave requests, profile management, document submission, personnel record updates, and internal process tracking.</p>
            </div>
            <div class="privacy-block">
                <h3>Who Can Use This</h3>
                <p>This page is intended for LTO personnel, HR officers, and authorized administrative staff who need secure access to employee-related workflows and records.</p>
            </div>
            <div class="privacy-block">
                <h3>Service Standards</h3>
                <p>Employee service requests are processed according to existing HR policies, approval workflows, and applicable government regulations to ensure consistency, accountability, and timely action.</p>
            </div>
        </div>
    </section>
