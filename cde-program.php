...
<body class="landing-page public-page-<?php echo htmlspecialchars(pathinfo($currentPage, PATHINFO_FILENAME)); ?>">
    ...
    <div class="public-wrap">
        <div class="public-hero">
            ...
            <h2 class="public-title">CDE Program</h2>
            <p class="public-summary">Public information page for the Continuing Driver Education (CDE) Program references.</p>
...
<li>Compliance</li>
            ...
            <div class="public-note">For clarifications related to CDE Program, contact the LTO Pila District Office through official channels.</div>
