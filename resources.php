...
<body class="landing-page public-page-<?php echo htmlspecialchars(pathinfo($currentPage, PATHINFO_FILENAME)); ?>">
    ...
    <div class="public-wrap">
        <div class="public-hero">
            ...
            <h2 class="public-title">Resources</h2>
            <p class="public-summary">Central resource hub for forms, supporting documents, and public reference materials.</p>

            <div class="public-grid">
                <article class="public-card">
                    <h3>Scope</h3>
                    <ul class="public-list">
<li>Access to downloadable resources.</li>
<li>Links to forms and support references.</li>
<li>Guidance on using updated document versions.</li>
                    </ul>
                </article>
                <article class="public-card">
...
<li>Downloads</li>
            ...
            <div class="public-note">For clarifications related to Resources, contact the LTO Pila District Office through official channels.</div>
