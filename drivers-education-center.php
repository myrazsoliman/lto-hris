...
<body class="landing-page public-page-<?php echo htmlspecialchars(pathinfo($currentPage, PATHINFO_FILENAME)); ?>">
    ...
    <div class="public-wrap">
        <div class="public-hero">
            ...
            <h2 class="public-title">Drivers Education Center</h2>
            <p class="public-summary">Public reference page for driver education center information and guidance.</p>
...
<li>Public Info</li>
            ...
            <div class="public-note">For clarifications related to Drivers Education Center, contact the LTO Pila District Office through official channels.</div>
            ...
            <div class="public-table-wrap">
                <table class="public-table">
                    ...
                    <tbody>
                        <tr>
                            <td>Drivers Education Center Information</td>
                            <td>Active</td>
