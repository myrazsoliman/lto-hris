...
$currentPage = basename($_SERVER['PHP_SELF'] ?? 'data-privacy-notice.php');
$publicNavItems = [
...
<title>Data Privacy Notice | LTO HRIS</title>
...
<body class="landing-page public-page-<?php echo htmlspecialchars(pathinfo($currentPage, PATHINFO_FILENAME)); ?>">
    ...
    <section class="public-page policy-page gov-policy-doc">
        <div class="public-wrap">
            <div class="public-hero policy-hero">
                ...
                <div class="gov-policy-sections gov-policy-accordion">
                    <details class="gov-policy-section" open>
                        <summary class="gov-policy-summary">1. Scope and Legal Basis</summary>
                    ...
                    <details class="gov-policy-section">
                        <summary class="gov-policy-summary">2. Institutional Privacy Commitments</summary>
                        <div class="gov-policy-content">
                    ...
                    <details class="gov-policy-section">
                        <summary class="gov-policy-summary">3. Data Subject Rights and Remedies</summary>
                        <div class="gov-policy-content">
                            <ul class="public-list policy-list">
                    ...
                    <details class="gov-policy-section gov-policy-footnote">
                        <summary class="gov-policy-summary">4. Policy Review and Updates</summary>
                        <div class="gov-policy-content">
    ...
    <script>
        ...
        (function() {
            const accordion = document.querySelector('.gov-policy-accordion');
            if (!accordion) return;

            const sections = Array.from(accordion.querySelectorAll('details.gov-policy-section'));
