...
<body class="landing-page public-page-<?php echo htmlspecialchars(pathinfo($currentPage, PATHINFO_FILENAME)); ?>">
    ...
    <div class="public-wrap">
        <div class="public-hero">
            ...
            <h2 class="public-title">Medical Clinics</h2>
            <p class="public-summary">Information page for medical clinic references related to LTO requirements and public verification.</p>
...
<li>Accredited</li>
            ...
            <div class="public-note">For clarifications related to Medical Clinics, contact the LTO Pila District Office through official channels.</div>
            ...
            <div class="public-table-wrap">
                <table class="public-table">
                    ...
                    <tbody>
                        <tr>
                            <td>Medical Clinics Information</td>
                            <td>Active</td>
