...
<body class="landing-page public-page-<?php echo htmlspecialchars(pathinfo($currentPage, PATHINFO_FILENAME)); ?>">
    ...
    <div class="public-wrap">
        <div class="public-hero">
            ...
            <h2 class="public-title">Driving School Instructors</h2>
            <p class="public-summary">Reference page for driving school instructor category information and compliance context.</p>
...
<li>Reference</li>
            ...
            <div class="public-note">For clarifications related to Driving School Instructors, contact the LTO Pila District Office through official channels.</div>
            ...
            <div class="public-table-wrap">
                <table class="public-table">
                    ...
                    <tbody>
                        <tr>
                            <td>Driving School Instructors Information</td>
                            <td>Active</td>
