...
<body class="landing-page public-page-<?php echo htmlspecialchars(pathinfo($currentPage, PATHINFO_FILENAME)); ?>">
    ...
    <div class="public-wrap">
        <div class="public-hero">
            ...
            <h2 class="public-title">Driving Schools</h2>
            <p class="public-summary">Information page for driving school references and public guidance under relevant LTO frameworks.</p>
...
<li>Accreditation</li>
            ...
            <div class="public-note">For clarifications related to Driving Schools, contact the LTO Pila District Office through official channels.</div>
            ...
            <div class="public-table-wrap">
                <table class="public-table">
                    ...
                    <tbody>
                        <tr>
                            <td>Driving Schools Information</td>
                            <td>Active</td>
