...
<title>Affiliates | LTO HRIS</title>
...
<body class="landing-page public-page-<?php echo htmlspecialchars(pathinfo($currentPage, PATHINFO_FILENAME)); ?>">
    ...
    <header class="site-header">
        ...
        <section class="public-page"><div class="public-wrap"><div class="public-hero"><span class="public-kicker">Official Public Information</span><h2 class="public-title">Affiliates</h2><p class="public-summary">Official partner platforms and linked public service channels.</p><div class="pub-layout"><article class="pub-panel"><h3>Affiliate Platforms</h3><div class="pub-link-grid"><a class="pub-link-card" href="ltms-portal.php">LTMS Portal</a><a class="pub-link-card" href="cde-program.php">CDE Program</a><a class="pub-link-card" href="cde-online-exam.php">CDE Online Exam</a><a class="pub-link-card" href="citisend.php">CitiSend</a></div></article><article class="pub-panel"><h3>Usage Reminder</h3><p>Access affiliate services only through official links and verified pages.</p></article></div></div></div></section>
