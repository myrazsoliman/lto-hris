...
<body class="landing-page public-page-<?php echo htmlspecialchars(pathinfo($currentPage, PATHINFO_FILENAME)); ?>">
    ...
    <div class="public-wrap">
        <div class="public-hero">
            ...
            <h2 class="public-title">LTMS Portal</h2>
            <p class="public-summary">Guidance page for LTMS portal references, access context, and related public reminders.</p>
...
<li>Access</li>
            ...
            <div class="public-note">For clarifications related to LTMS Portal, contact the LTO Pila District Office through official channels.</div>
