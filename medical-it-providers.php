...
<body class="landing-page public-page-<?php echo htmlspecialchars(pathinfo($currentPage, PATHINFO_FILENAME)); ?>">
    ...
    <div class="public-wrap">
        <div class="public-hero">
            ...
            <h2 class="public-title">Medical IT Providers</h2>
            <p class="public-summary">Reference page for medical IT provider category context and related compliance guidance.</p>
...
<li>Reference</li>
            ...
            <div class="public-note">For clarifications related to Medical IT Providers, contact the LTO Pila District Office through official channels.</div>
            ...
            <div class="public-table-wrap">
                <table class="public-table">
                    ...
                    <tbody>
                        <tr>
                            <td>Medical IT Providers Information</td>
                            <td>Active</td>
