...
<body class="landing-page public-page-<?php echo htmlspecialchars(pathinfo($currentPage, PATHINFO_FILENAME)); ?>">
    ...
    <div class="public-wrap">
        <div class="public-hero">
            ...
            <h2 class="public-title">Lecturers</h2>
            <p class="public-summary">Public guidance page for lecturer-related references under LTO accreditation-linked programs.</p>
...
<li>Reference</li>
            ...
            <div class="public-note">For clarifications related to Lecturers, contact the LTO Pila District Office through official channels.</div>
