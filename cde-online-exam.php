...
<title>CDE Online Exam | LTO HRIS</title>
...
<body class="landing-page public-page-<?php echo htmlspecialchars(pathinfo($currentPage, PATHINFO_FILENAME)); ?>">
    ...
    <header class="site-header">
        ...
        <section class="public-page"><div class="public-wrap"><div class="public-hero"><span class="public-kicker">Official Public Information</span><h2 class="public-title">CDE Online Exam</h2><p class="public-summary">Reference page for CDE online exam context and user reminders.</p><div class="pub-layout"><article class="pub-panel"><h3>Key Functions</h3><ul class="public-list"><li>User access and verification support</li><li>Transaction and status visibility</li><li>Policy-linked compliance references</li></ul></article><article class="pub-panel"><h3>Access Path</h3><div class="pub-process"><div class="pub-step">Open the official platform link.</div><div class="pub-step">Confirm identity and account context.</div><div class="pub-step">Complete transaction using posted guidance.</div></div></article></div></div></div></section>
