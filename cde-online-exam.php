...
<body class="landing-page public-page-<?php echo htmlspecialchars(pathinfo($currentPage, PATHINFO_FILENAME)); ?>">
    ...
    <div class="public-wrap">
        <div class="public-hero">
            ...
            <h2 class="public-title">CDE Online Exam</h2>
            <p class="public-summary">Reference page for CDE Online Exam guidance, reminders, and policy-related notices.</p>
...
<li>Guidance</li>
            ...
            <div class="public-note">For clarifications related to CDE Online Exam, contact the LTO Pila District Office through official channels.</div>
            ...
            <div class="public-table-wrap">
                <table class="public-table">
                    ...
                    <tbody>
                        <tr>
                            <td>CDE Online Exam Information</td>
                            <td>Active</td>
