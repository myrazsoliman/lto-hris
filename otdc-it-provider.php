...
<body class="landing-page public-page-<?php echo htmlspecialchars(pathinfo($currentPage, PATHINFO_FILENAME)); ?>">
    ...
    <div class="public-wrap">
        <div class="public-hero">
            ...
            <h2 class="public-title">OTDC IT Provider</h2>
            <p class="public-summary">Public reference for OTDC IT provider category information under accreditation-linked services.</p>
...
<li>Compliance</li>
            ...
            <div class="public-note">For clarifications related to OTDC IT Provider, contact the LTO Pila District Office through official channels.</div>
            ...
            <div class="public-table-wrap">
                <table class="public-table">
                    ...
                    <tbody>
                        <tr>
                            <td>OTDC IT Provider Information</td>
                            <td>Active</td>
